...
public class BotConfig {
    public static final float PASSIVITY = 0.01f; // probability to place on the back - suggested [<0.1]
    public static final int GOLDWEIGHT = 20; // suggested [10-50]
    public static final int RESOURCEWEIGHT = 1; // suggested [1]
    public static final int SPEED = 1000; // speed for command insertion (millisecond) - suggested [10-1000]
}
